...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jMSCMSDATAFlex2Label0 = new JLabel();
	JTextField jMSCMSDATAFlex2TextField0 = new JTextField();

	JLabel jinputLabel1 = new JLabel();
	JTextField jinputTextField1 = new JTextField();

	JLabel jEPSupportLabel2 = new JLabel();
	JTextField jEPSupportTextField2 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2015r4sp1");
	...
	protected void fillScrollPane() {
		...
		jMSCMSDATAFlex2Label0.setText("Source instance of MSCMSDATAFlex file:");
		jMSCMSDATAFlex2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jMSCMSDATAFlex2Label0, null);
		jMSCMSDATAFlex2TextField0.setText("MSCMSDATA.txt");
		jMSCMSDATAFlex2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jMSCMSDATAFlex2TextField0.setEditable(false);
		jPanelStructures.add(jMSCMSDATAFlex2TextField0, null);

		jinputLabel1.setText("Input Parameter : input");
		jinputLabel1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jinputLabel1, null);

		jinputTextField1.setText("" );
		jinputTextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jinputTextField1.setEditable(true);
		jinputTextField1.addKeyListener(new MappingFrame_jinputTextField1_keyAdapter( this ) );
		jPanelStructures.add(jinputTextField1, null);

		jEPSupportLabel2.setText("JDBC-URL of EPSupport database:");
		jEPSupportLabel2.setBounds(new Rectangle(15, 110, 438, 23));
		jPanelStructures.add(jEPSupportLabel2, null);

		jEPSupportTextField2.setText("jdbc:sqlserver://ERP;DatabaseName=EPSupport");
		jEPSupportTextField2.setBounds(new Rectangle(15, 135, 438, 23));
		jEPSupportTextField2.setEditable(false);
		jPanelStructures.add(jEPSupportTextField2, null);

		jPanelStructures.setLayout(null);
		jPanelStructures.setPreferredSize(new Dimension(135, 500));
		jPanelStructures.setSize(new Dimension(135, 500));
		jPanelStructures.setMinimumSize(new Dimension(135, 500));
		jPanelStructures.setMaximumSize(new Dimension(135, 500));
	}
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		...
		java.sql.DriverManager.setLogWriter(new java.io.PrintWriter(new java.io.StringWriter()/*java.lang.System.out*/));
			...
			{
				System.err.println("Missing argument input");
				System.exit(1);
			}
			...
			// MappingMapToEPSupportObject.setCloseObjectsAfterRun(false);

			{
				com.altova.io.Input MSCMSDATAFlex2Source = com.altova.io.StreamInput.createInput("MSCMSDATA.txt");

				MappingMapToEPSupportObject.run(
						MSCMSDATAFlex2Source,
						com.altova.CoreTypes.castToString((String)mapArguments.get("input")),
						com.altova.db.Dbs.newConnection(
							"jdbc:sqlserver://ERP;DatabaseName=EPSupport",
							"sa",
							""));
	...
	void jinputTextField1_actionPerformed( KeyEvent e ) {
		if ( e.getSource().equals( jinputTextField1 ) ) {
			String value = jinputTextField1.getText();
			if( value.length() != 0 )
...
class MappingFrame_jinputTextField1_keyAdapter
	implements java.awt.event.KeyListener {
	MappingFrame adaptee;

	MappingFrame_jinputTextField1_keyAdapter( MappingFrame adaptee ) {
		this.adaptee = adaptee;
	}

	public void keyTyped( KeyEvent e ) {
		adaptee.jinputTextField1_actionPerformed( e );
	}
